...
namespace MobileAutoTest.Utilities
{
    public class TestBase
    {
        ...
        public static string sitemapsExcelPath = $@"{Upperfolderpath}xmlURLList";
        ...
        public static string PageSnapshotToReport_Android(AndroidDriver<AndroidElement> driver)
        {
            var img_HTML = string.Empty;
            Screenshot ss = ((ITakesScreenshot)driver).GetScreenshot();
            var screenshotByArray = ss.AsByteArray;
            var temp_inBase64 = Convert.ToBase64String(screenshotByArray);
            img_HTML = "<img style=\"width: 450px;\" src=\"data:image/jpg;base64, " + temp_inBase64 + "\"/>";
            return img_HTML;
        }
